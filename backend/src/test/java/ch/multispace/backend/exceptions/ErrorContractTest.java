...
/**
 * Pins the status codes malformed/unroutable requests get, independent of any
 * application-level exception. GlobalExceptionHandler must not pre-empt
 * Spring's own translation of these into their correct 4xx statuses.
 */
@SpringBootTest
